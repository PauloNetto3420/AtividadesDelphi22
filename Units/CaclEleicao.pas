...
var
  ...
  if Total <= Eleitores  then
   begin
    ...
    LabelVN.Caption := ('A porcemtagem de votos Nulos é ' + FloatToStr(Porc2) + '%');
    LabelVB.Caption := ('A porcetagem de votos brancos é '+ FloatToStr(porc3) + '%');
    LabelVV.Caption := ('A porcetagem de votos validos é '+ FloatToStr(porc1) + '%');
    end
    else
    begin
      ShowMessage('Você inseriu mais votos do que eleitores');
    end;
